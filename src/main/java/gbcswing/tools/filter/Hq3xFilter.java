...
/**
 * Java implementation of the hq3x magnification filters. Based on Maxim Stepin's
 * C implementation.
 *
 * @author niuhuan (niuhuancn@outlook.com)
 */

public class Hq3xFilter extends Hq0xFilter
{
            ...
            for (int i = 0; i < width; i++)
            {
                ...
                switch (pattern)
                {
                    ...
                    case 165:
                    {
                        ...
                        interp2(newPixels, newIndex + 2, c[5], c[2], c[6]);
                        interp1(newPixels, newIndexWidth, c[5], c[4]);
                        newPixels[newIndexWidth + 1] = c[5];
                        interp1(newPixels, newIndexWidth + 2, c[5], c[6]);
                        interp2(newPixels, newIndexWidth2,
                            c[5], c[8], c[4]);
                        interp1(newPixels, newIndexWidth2 + 1,
                            c[5], c[8]);
                        interp2(newPixels, newIndexWidth2 + 2,
                            c[5], c[6], c[8]);
                        break;
                    }
                    case 2:
                    ...
                    case 49:
                    {
                        ...
                        interp1(newPixels, newIndexWidth2 + 1,
                            c[5], c[8]);
                        interp1(newPixels, newIndexWidth2 + 2,
                            c[5], c[9]);
                        break;
                    }
                    case 64:
                    ...
                    case 69:
                    {
                        ...
                        newPixels[newIndexWidth + 1] = c[5];
                        interp1(newPixels, newIndexWidth + 2, c[5], c[6]);
                        interp1(newPixels, newIndexWidth2,
                            c[5], c[7]);
                    ...
                    case 166:
                    {
                        interp1(newPixels, newIndex, c[5], c[1]);
                        newPixels[newIndex + 1] = c[5];
                        interp1(newPixels, newIndex + 2, c[5], c[6]);
                        interp1(newPixels, newIndexWidth, c[5], c[4]);
                        newPixels[newIndexWidth + 1] = c[5];
                        interp1(newPixels, newIndexWidth + 2, c[5], c[6]);
                        interp2(newPixels, newIndexWidth2,
                    ...
                    case 50:
                    {
                        ...
                        {
                            interp3(newPixels, newIndex + 1, c[5], c[2]);
                            interp4(newPixels, newIndex + 2, c[5], c[2], c[6]);
                            interp3(newPixels, newIndexWidth + 2, c[5],
                                c[6]);
                        }
                        interp1(newPixels, newIndexWidth, c[5], c[4]);
                        newPixels[newIndexWidth + 1] = c[5];
                    ...
                    case 81:
                    {
                        ...
                        else
                        {
                            interp3(newPixels, newIndexWidth + 2, c[5],
                                c[6]);
                            interp3(newPixels, newIndexWidth2
                                + 1, c[5], c[8]);
                            interp4(newPixels, newIndexWidth2
                                + 2, c[5], c[6], c[8]);
                        }
                        break;
                    }
                    ...
                    case 76:
                    {
                        ...
                        {
                            interp3(newPixels, newIndexWidth, c[5], c[4]);
                            interp4(newPixels, newIndexWidth2,
                                c[5], c[8], c[4]);
                            interp3(newPixels, newIndexWidth2
                                + 1, c[5], c[8]);
                    ...
                    case 138:
                    {
                        ...
                        {
                            interp4(newPixels, newIndex, c[5], c[4], c[2]);
                            interp3(newPixels, newIndex + 1, c[5], c[2]);
                            interp3(newPixels, newIndexWidth, c[5], c[4]);
                        }
                        interp1(newPixels, newIndex + 2, c[5], c[3]);
                    ...
                    case 51:
                    {
                        ...
                        else
                        {
                            ...
                            interp5(newPixels, newIndex + 2, c[2], c[6]);
                            interp1(newPixels, newIndexWidth + 2, c[5],
                                c[6]);
                        }
                        interp1(newPixels, newIndexWidth, c[5], c[4]);
                        newPixels[newIndexWidth + 1] = c[5];
                    ...
                    case 178:
                    {
                        ...
                        else
                        {
                            interp1(newPixels, newIndex + 1, c[5], c[2]);
                            interp5(newPixels, newIndex + 2, c[2], c[6]);
                            interp1(newPixels, newIndexWidth + 2, c[6],
                                c[5]);
                            interp2(newPixels, newIndexWidth2
                                + 2, c[5], c[6], c[8]);
                        }
                    ...
                    case 85:
                    {
                        ...
                        else
                        {
                            ...
                            interp1(newPixels, newIndexWidth2
                                + 1, c[5], c[8]);
                            interp5(newPixels, newIndexWidth2
                                + 2, c[6], c[8]);
                        }
                        interp2(newPixels, newIndex, c[5], c[4], c[2]);
                        interp1(newPixels, newIndex + 1, c[5], c[2]);
                    ...
                    case 170:
                    {
                        ...
                        {
                            interp5(newPixels, newIndex, c[4], c[2]);
                            interp1(newPixels, newIndex + 1, c[5], c[2]);
                            interp1(newPixels, newIndexWidth, c[4], c[5]);
                            interp2(newPixels, newIndexWidth2,
                                c[5], c[8], c[4]);
